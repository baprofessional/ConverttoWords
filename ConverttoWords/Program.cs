...
namespace ConverttoWords
{
    public class NumberToWords
    {
        ...
        public void NumberCovertion(char[] num)
        {
        ...
        {
            NumberToWords objNW = new NumberToWords();
            objNW.NumberCovertion("1234".ToCharArray());
            objNW.NumberCovertion("550".ToCharArray());
            objNW.NumberCovertion("120".ToCharArray());
            objNW.NumberCovertion("9899".ToCharArray());
            Console.Read();
        }
    }
}
